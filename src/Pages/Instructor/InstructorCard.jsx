...
const InstructorCard = ({ instructor }) => {
  return (
    ...
    <Link className="group relative block bg-black rounded-md shadow-md">
      <img
        alt="instructors"
        src={instructor?.photo}
        className="absolute inset-0 rounded-md h-full w-full object-center opacity-75 transition-opacity group-hover:opacity-50"
      />
      ...
      <div className="relative p-4 sm:p-6 lg:p-8">
        <div className="mt-32 sm:mt-48 lg:mt-64 ">
          ...
          <div className="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
            <p className="text-xl font-medium text-blue-500 transition-all">
              {instructor?.email}
            </p>
            <p className="text-xl font-medium text-blue-500 transition-all">
              {instructor?.phone}
